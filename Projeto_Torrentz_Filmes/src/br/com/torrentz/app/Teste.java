...
//         jTextFieldDataFim.setText("");
    ...
    private void initComponents() {
        ...
        Usuários = new javax.swing.JTabbedPane();
        ...
        if (jTableCategoria.getColumnModel().getColumnCount() > 0) {
            jTableCategoria.getColumnModel().getColumn(0).setMinWidth(80);
            jTableCategoria.getColumnModel().getColumn(0).setPreferredWidth(80);
            jTableCategoria.getColumnModel().getColumn(0).setMaxWidth(80);
        }
        ...
        Usuários.addTab("Categorias", jPanel1);
        ...
        Usuários.addTab("Planos", jPanel2);
        ...
        if (jTableFilmes.getColumnModel().getColumnCount() > 0) {
            jTableFilmes.getColumnModel().getColumn(0).setMinWidth(80);
            jTableFilmes.getColumnModel().getColumn(0).setPreferredWidth(80);
        ...
        Usuários.addTab("Filmes", jPanel3);
        ...
        if (jTable_usuarios.getColumnModel().getColumnCount() > 0) {
            jTable_usuarios.getColumnModel().getColumn(0).setMinWidth(80);
            jTable_usuarios.getColumnModel().getColumn(0).setPreferredWidth(80);
            jTable_usuarios.getColumnModel().getColumn(0).setMaxWidth(80);
        }
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jPasswordField_ConfirmSenha_USU, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        Usuários.addTab("Usuários", jPanel4);
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel6Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(jTextFieldStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        Usuários.addTab("Contratos", jPanel6);
        ...
        Usuários.addTab("Play Torrentz Filmes", jPanel7);
    ...
    private void jButtonRemoverFilmesActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        try {
    ...
    private void jButtonAlterarFilmesActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        try {
            if (jTableFilmes.getSelectedRow() == -1) {
    ...
    private void jButtonAdicionarFilmesActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        try {
    ...
    private void jTableFilmesMouseClicked(java.awt.event.MouseEvent evt) {                                          
        try {
    ...
    private void jButtonAlterarPlanoActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        try {
    ...
    private void jButtonRemoverPlanosActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        try {
            if (jTablePlanos.getSelectedRow() == -1) {
    ...
    private void jButtonAdicionarPlanosActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        try {
            ValidaFormularioPlanos();
            planos.setPla_acesso_simultaneo(Integer.parseInt(jTextFieldAcessos.getText()));
            planos.setPla_nome(jTextFieldPlanosNome.getText());
    ...
    private void jTablePlanosMouseClicked(java.awt.event.MouseEvent evt) {                                          
        try {
    ...
    private void jButtonRemoverCategoriaActionPerformed(java.awt.event.ActionEvent evt) {                                                        
        try {
    ...
    private void jButtonAlterarCategoriaActionPerformed(java.awt.event.ActionEvent evt) {                                                        
    ...
    private void jButtonAdicionarCategoriaActionPerformed(java.awt.event.ActionEvent evt) {                                                          
        try {
            validarFormularioCategorias();
            categoria.setCat_nome(jTextFieldNome.getText());
    ...
    private void jTableCategoriaMouseClicked(java.awt.event.MouseEvent evt) {                                             
        try {
    ...
    private void jButton_adicionar_usuariosActionPerformed(java.awt.event.ActionEvent evt) {                                                           
        try {
    ...
    private void jButton_alterar_usuarioActionPerformed(java.awt.event.ActionEvent evt) {                                                        
        try {
    ...
    private void jButton_remover_usuarioActionPerformed(java.awt.event.ActionEvent evt) {                                                        
        // TODO add your handling code here:
    }                                                       

    private void jTableContratosMouseClicked(java.awt.event.MouseEvent evt) {                                             
    ...
    private void jButtonRemoverContratoActionPerformed(java.awt.event.ActionEvent evt) {                                                       
    ...
    private void jButtonAdicionarContratoActionPerformed(java.awt.event.ActionEvent evt) {                                                         
    ...
    private void jButtonAlterarContratoActionPerformed(java.awt.event.ActionEvent evt) {                                                       
    ...
    private void jButtonVisualizacaoCompletaActionPerformed(java.awt.event.ActionEvent evt) {                                                            


try {

          //  if (  visualizado.setVis_completo(true){
...
//            visualizado.setVis_data_geracao(formate.format(Inicio));
            ...
            jTextFieldDataVisCompleta.setText("Visualização Completa com Data tal ");
    ...
    private javax.swing.JTabbedPane Usuários;
